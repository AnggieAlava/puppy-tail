    ...
    return (
        <section className="py-5 description-bg">
            <div className="container wrap-description">
                <h2 className='text-center p-3 title-steps'>Encuentra el compañero perfecto para tu mascota en 4 simples pasos:</h2>
                <div className="row">
                    <div className="col-md-3">
                        <div className="card text-center mb-3 card-description">
                            <img
                    ...
                    <div className="col-md-3">
                        <div className="card text-center mb-3 card-description">
                            ...
                            <div className="card-body">
                                ...
                                <h4>Confirma la disponibilidad</h4>
                                <p className="card-text card-steps-text">
                    ...
                    <div className="col-md-3">
                        <div className="card text-center mb-3 card-description">
                            ...
                            />
                            <div className="card-body">
                                <h3 className="card-title card-steps-title">Paso 4</h3>
                                <h4>Hazlo oficial</h4>
                                <p className="card-text card-steps-text">
